...
- Example eval (after training):
```bash
python scripts/eval_lstm.py --checkpoint reports/lstm_baseline/epoch=...ckpt
```
...
- Latest trained checkpoint (15 epochs): `reports/tft/lightning_logs/version_3/checkpoints/epoch=14-step=10170.ckpt`
